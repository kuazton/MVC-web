        ...
        <div>
            ...
            <form for="index.php" id="form1" class="p-4 rounded-4" method="POST" id="frmins">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="TextInput" class="form-control" placeholder="Ej: Juan" name="nombre" required>
                    </div>
                    <div class="mb-3">
                        <label for="apeper" class="form-label">Apellido</label>
                        <input type="text" id="apeper" class="form-control" placeholder="Ej: Perez" name="apellido" required>
                    </div>
                    <div class="mb-3">
                        <label for="corrper" class="form-label">Correo</label>
                        <input type="text" id="corrper" class="form-control" placeholder="Ej: correo@gmail.com" name="correo" required>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="sexo" id="inlineRadio2" value="2" required>
